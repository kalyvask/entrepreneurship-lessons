...
"Lean" does not mean inexpensive. It comes from lean manufacturing — fail fast, cheap, on the assembly line, before defective parts propagate.

## The two hypotheses

### The value hypothesis

Three components. Each must be specific.

- **What** — the product
- **Who** — the customer
- **How** — the delivery, distribution, pricing

If all three are right, you have a product that someone is desperate for and a way to get it to them economically. The value hypothesis is what you'd build, sell, and deliver — *pre-evidence.* The job of the early stage is to validate it.

### The growth hypothesis

How you grow your customer base beyond word of mouth in a cost-effective way.
...
The leap of faith assumption is the **one thing that must be true** for the business to work. It is *not* the value hypothesis. It is the underlying belief on which the value hypothesis rests. The value hypothesis is the *what, who, how* you choose *because* of the leap.
...
## Iterate the *who*, not the *what*

When experiments fail, 99% of founders add features. Lunacy. **Iterate the *who*. Sometimes the *how*. Almost never the *what*.**

Why not change the *what*?

1. **Changing the *what* obsoletes the original insight.** Your insight is what makes you defensible. A new *what* requires a new insight.
2. **Adding features doesn't make someone desperate.** If they weren't desperate before, an extra feature won't change that.
3. **If you don't know your ideal customer, how do you know which features to build?**
4. **Changing the *what* changes too many variables at once.** A scientist can't change the drug, dosage, patient population, and delivery mechanism in the same trial.
...
1. Identify the inflection point. Tech, ideally — most durable.
2. Articulate the value hypothesis with three components and a single leap of faith.
3. Founders' feedback meeting. Critic panel, not approval committee.
4. Test the concept. Smoke test, video, concierge, follow-me-home, keyword search. Days, not weeks.
5. Test the implementation. Three-day Knapp sprint. Skip if MVP is under two months of build.
6. Build the MVP. Smallest feature set. Desperate-customer threshold. Use partners where you must.
7. Run product reviews every two weeks during MVP development.
8. Measure with one metric. Consumer: exponential organic growth in paying users. Enterprise: sales yield > 1.
...
3. Start with an insight from a technological inflection, not a market
4. Authenticity beats analysis; great ideas find you
5. Need is irrelevant; desperation is everything
6. Iterate the *who*; sometimes the *how*; never the *what*
7. Competitors are irrelevant pre-PMF
8. First to PMF wins, not first to market
9. Without change, there is seldom opportunity
10. Define your audience as narrowly as you can
11. Markets are customers who reference each other
12. Validate concept → implementation → MVP
13. Word of mouth is at least 10× retention
14. Surprise trumps everything; savor it
15. Fixing the bad never improves growth; enhancing the good does
16. Disruption = simpler, cheaper, more convenient + uneconomic for the incumbent
17. Work with partners (the right kind); ignore competition
18. Build to learn pre-PMF; build to execute after
19. Stockholders rent your stock; manage to the mission
20. You're going to fail; the methodology makes failure cheaper, faster, more informative
...
- [Stage 01 — Insight and Idea](../stages/01_insight_and_idea.md) — finding the insight that becomes the value hypothesis
- [Stage 04 — Value Hypothesis](../stages/04_value_hypothesis.md) — writing the three-part hypothesis + leap of faith
- [Stage 06 — PMF Measurement](../stages/06_pmf_measurement.md) — measuring whether you've achieved it
- [Stage 07 — Pivot or Persevere](../stages/07_pivot_or_persevere.md) — what to change when you haven't
